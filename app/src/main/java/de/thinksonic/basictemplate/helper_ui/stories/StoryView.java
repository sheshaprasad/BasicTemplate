package de.thinksonic.basictemplate.helper_ui.stories;
...
public class StoryView extends View {
    ...
    public void setStoriesModels(RealmList<StoryModel> storiesModels) {
        this.storiesModels = storiesModels;
        calculateSweepAngle(storiesModels.size());
        invalidate();
        loadFirstImageBitmap(storiesModels.last().getFile(), storiesModels.last().getType());
